...
Cursor is stricter: its ACP adapter supports the model axis but refuses a non-default effort before endpoint creation because silently omitting that dispatch intent would be misleading.
