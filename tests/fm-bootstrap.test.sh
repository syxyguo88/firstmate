...
cursor model profile is accepted^{"rules":[{"when":"cursor acp work","use":{"harness":"cursor","model":"cursor-model"}}]}^empty^
unsupported cursor effort is flagged^{"rules":[{"when":"cursor acp work","use":{"harness":"cursor","model":"cursor-model","effort":"high"}}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - invalid effort: cursor:high
